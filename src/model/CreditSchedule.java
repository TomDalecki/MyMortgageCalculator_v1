...
public class CreditSchedule {
    ...
    public CreditSchedule(BigDecimal rateNumber, LocalDate ratePaymentDate, BigDecimal rateAmount, BigDecimal capitalAmount, BigDecimal interestAmount, BigDecimal capitalResidual, BigDecimal monthsResidual) {
    ...
    public String toString() {
        return "rateNumber: " + rateNumber +
                ", ratePaymentDate: " + ratePaymentDate +
                ", rateAmount: " + rateAmount +
                ", capitalAmount: " + capitalAmount +
                ", interestAmount: " + interestAmount +
                ", capitalResidual: " + capitalResidual +
                ", monthsResidual:" + monthsResidual;
    }
}
